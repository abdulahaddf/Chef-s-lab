        ...
        <div>
            ...
            <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
                ...
                <div className="flex mt-4 gap-x-2">
                    ...
                    <button onClick={signInGit} className="flex items-center justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-violet-600">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 32 32"
                            className="w-5 h-5 fill-current"
