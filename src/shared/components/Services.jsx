...
const Services = () => {
  return (
    <div className="border shadow-lg border-purple-600 w-11/12 mx-auto">
        <h2 className="text-4xl text-purple-600  font-bold mb-4 text-center">Our Services</h2>
    <div className="flex justify-evenly py-10 ">
    <div className="card card-compact w-1/5 py-5 text-centerbg-base-100 shadow-lg">
        <LazyLoad>
          <img className="w-24 h-32 mx-auto"
